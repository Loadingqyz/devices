+(function($){
    ...
    Pagination.prototype = {
        ...
        _render: function(){
            ...
            str += '<li class="page-item" data-page="' + this._previousPage() + '"><a class="page-link" href="javascript:void(0);">' + this.options.previous + '</a></li>';
            for(start; start <= end; start++) {
                if(start == this.options.page)
                    active = ' active';
                else
                    active = '';
                str += '<li class="page-item' + active + '" data-page="' + start + '"><a class="page-link" href="javascript:void(0);">' + start + '</a></li>';
            }
            str += '<li class="page-item" data-page="' + this._nextPage() + '"><a class="page-link" href="javascript:void(0);">' + this.options.next + '</a></li>';
            str += '</ul>';
